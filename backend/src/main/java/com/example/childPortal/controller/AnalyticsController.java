...
public class AnalyticsController {
  ...
  public ResponseEntity<AdminDashboardOverviewDTO> getAdminDashboardOverview() {
    AdminDashboardOverviewDTO overview = analyticsService.getAdminDashboardOverview();
