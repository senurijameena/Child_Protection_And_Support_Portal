...
public class HelpController {
    ...
    public ResponseEntity<HelpRequestDTO> getHelpRequest(@PathVariable String requestId) { 
        ...
        return helpRequestDTO != null ?  
            ResponseEntity.ok(helpRequestDTO) :  
            ResponseEntity.notFound().build(); 
    } 
 
    @GetMapping("/my-requests") 
    public ResponseEntity<List<HelpRequestDTO>> getMyHelpRequests(@RequestParam String userId) { 
    ...
    public ResponseEntity<HelpRequestDTO> updateHelpRequestStatus( 
            ...
            @RequestParam RequestStatus status) { 
                HelpRequestDTO updatedRequest = helpRequestService.updateHelpRequestStatus(requestId, status); 
    ...
    public ResponseEntity<HelpRequestDTO> assignToSocialWorker( 
            ...
            @RequestParam String workerId) { 
                HelpRequestDTO updatedRequest = helpRequestService.assignHelpRequestToWorker(requestId, workerId); 
                return updatedRequest != null ?  ResponseEntity.ok(updatedRequest) :  ResponseEntity.notFound().build(); 
    } 
