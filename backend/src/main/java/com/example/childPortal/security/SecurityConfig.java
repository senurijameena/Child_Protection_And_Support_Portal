        ...
        http
         .cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/services/offer").hasAuthority("ROLE_PO","ROLE_SW") 
                .requestMatchers("/api/services/worker/**").hasAuthority("ROLE_PO","ROLE_SW") 
                .requestMatchers("/api/services/expired").hasAuthority("ROLE_PO","ROLE_SW")
