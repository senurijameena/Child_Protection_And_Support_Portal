...
import com.example.childPortal.model.CaseTimelineEvent.EventType; import java.util.List;

public interface CaseTimelineService {
  void createTimelineEvent(CaseTimelineDTO timelineDTO); List<CaseTimelineDTO> getTimelineForCase(String caseId);
