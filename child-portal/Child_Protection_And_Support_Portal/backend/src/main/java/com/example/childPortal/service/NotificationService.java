...
public class NotificationService {
    ...
    public void sendCaseCreatedNotification(String userId, String caseId, boolean isAnonymous) {
        // Always send app notification
        logNotification(userId, "CASE_CREATED", "Your case " + caseId + " has been created successfully");
        ...
        if (!isAnonymous && userId != null) {
            try {
                ...
                String content = "<h2>Case Created Successfully</h2>" +
                    ...
                    "<a href='" + appUrl + "/cases/" + caseId + "'>View Case Details</a>";
                sendEmail(user.getEmail(), subject, content);
            } catch (Exception e) {
    ...
    public void sendHelpRequestCreatedNotification(String userId, String requestId, boolean isAnonymous) {
        // Always send app notification
        logNotification(userId, "HELP_REQUEST_CREATED", "Your help request " + requestId + " has been created successfully");
        ...
        if (!isAnonymous && userId != null) {
            try {
                ...
                String content = "<h2>Help Request Created Successfully</h2>" +
                    ...
                    "<a href='" + appUrl + "/help-requests/" + requestId + "'>View Request Details</a>";
                sendEmail(user.getEmail(), subject, content);
            } catch (Exception e) {
