              ...
              <div className="testimonial-content">
                ...
                <div className="testimonial-author-info">
                  <div className="author-name fw-bold">
                    {currentTestimonial.userName || 'Anonymous User'}
                  </div>
                  <div className="testimonial-meta text-muted small">
                    📍 Case #{currentTestimonial.id?.toUpperCase() || 'N/A'} | 
                    Resolved: {formatDate(currentTestimonial.createdAt)} | 
                    Officer: {currentTestimonial.userName || 'N/A'}
                  </div>
                </div>
              </div>
            </Card.Body>
