...
const NotificationCenterPage: React.FC = () => {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    } else if (notification.type === 'CASE_UPDATE' || notification.type === 'EVIDENCE') {
      if (notification.caseId) navigate(`/cases/${notification.caseId}`);
      else navigate('/cases/my-cases');
    } else if (notification.type === 'HELP_REQUEST') {
      if (notification.helpRequestId) navigate(`/help-requests/${notification.helpRequestId}`);
      else navigate('/help-requests/my-requests');
