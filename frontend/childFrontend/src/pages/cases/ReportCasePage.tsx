  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.data?.success) {
        // Use trackingId from response, fallback to caseId if not available
        const displayId = response.data.trackingId || response.data.caseId || response.data.id;
        setSubmittedCaseId(displayId);
            ...
            <Card className="success-info-card mb-4">
              <Card.Body>
                ...
                <div className="mb-3">
                  ...
                  {formData.caseType === 'MISSING_CHILD' && (
